  ...
  return (
    <div className="w-[660px] mx-auto mb-[20px]  bg-gray-100 fixed top-0 right-0 h-full z-50 overflow-y-auto p-4 rounded-[7px]">
      <div className="flex items-center justify-between">
        ...
        <div className="">
          <h3 onClick={close} className="text-[30px] text-gray-600">X</h3>
        </div>
      </div>
      ...
      <div className="flex justify-between mt-[20px] mb-[50px]">
        <button className="bg-[#0aad0a] text-white p-2 rounded-[7px]">Continue Shopping</button>
        <button className="bg-[#0aad0a] text-white p-2 rounded-[7px]">Update Cart</button>
      </div>
    </div>
  );
}
